...
<head>
    ...
    <!-- TITLE -->
    <title>Federal Polytechnic Ilaro 3rd International Conference Admin</title>
                        ...
                        <form class="login100-form validate-form" action="logic/login.php" method="POST">
                            ...
                            <?php 
                                if(isset($_SESSION['err'])) { ?>
                                    <div class="alert alert-danger rounded-0"><?= $_SESSION['err'] ?></div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab5">
                                            <div class="wrap-input100 validate-input input-group" data-bs-validate="Valid email is required: ex@abc.xyz">
                                                ...
                                                <input class="input100 border-start-0 form-control ms-0" type="text" name="username" placeholder="Email Address">
                                            </div>
