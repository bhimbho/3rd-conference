...
class validate{
    ...
    public function fileUploadValidateDoc($_path, $filename, $type = null)
	{
	/*
	...
	*/
	...
	if ($type !== null) {
		if($targetFileExtension != 'jpg' && $targetFileExtension != 'png' && $targetFileExtension !='jpeg' && $targetFileExtension != 'gif')
		{
			$checkCounter = 0;
